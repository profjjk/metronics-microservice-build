...
const fetchJob = async (id) => await API.getjobById(id);

const JobForm = ({ selectedJob, setShowForm }) => {
  // Fetch jobViewModel by id from main-service API.
        ...
        <>
          <form className="p-5" onSubmit={handleSubmit} >
            ...
            <div id="dropdown-area" className="my-3">
              <div className="px-3">
                <h6>Status</h6>
                <select className="form-select" name="status" onChange={handleJobChange}>
              ...
              <div className="px-3">
                <h6>Type</h6>
                <select className="form-select" name="type" onChange={handleJobChange}>
            ...
            <div id="notes-area" className="my-3 px-3">
              ...
              placeholder={data.problemNotes} onChange={handleJobChange}></textarea>
              <h6 className="mt-3">Repair Notes</h6>
              <textarea className="form-control" name="repairNotes" 
              placeholder={data.repairNotes} onChange={handleJobChange}></textarea>
            </div>
