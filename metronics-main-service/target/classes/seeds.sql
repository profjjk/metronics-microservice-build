-- PARTS
use metronics_parts;
insert into parts (id, description, part_number, purchase_price, quantity, sale_price)
...
-- JOBS
use metronics_jobs;
insert into jobs (id, customer_id, date_completed, invoice_number, problem_notes, repair_notes, status, type)
...
insert into customers (id, business_name, contact_name, phone, street, city, state, zipcode)
