...
public class CustomerControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        doReturn(Optional.of(customerOutput)).when(mockRepo).findById(2);
        doReturn(customerOutput).when(mockRepo).save(customerInput);
        doReturn(customerList).when(mockRepo).findAll();
